...
from auth import AuthManager, Profile, get_profile_cookies
from exceptions import AccountMismatchError, AuthError, ProfileNotFoundError
...
class TestAuthManager:
  def _make_manager(self, tmp_path, monkeypatch):
    monkeypatch.setattr("config.get_profile_dir", lambda name: tmp_path / "profiles" / name)
